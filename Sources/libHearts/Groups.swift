...
actor Groups {
    ...
    private let groups: Dictionary<String, Set<Character>>
    
    private init() throws {
        let groups = try JSONSerialization.jsonObject(with: Data(contentsOf: dataURL)) as! Dictionary<String, String>
    ...
    func characters(for groupNames: Array<String>) -> Set<Character> {
